...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.waters.punchout.exception.CxmlConversionException.class)
    public ResponseEntity<ConversionResponse> handleCxmlConversionException(com.waters.punchout.exception.CxmlConversionException ex) {

...
# Simple version - builds JARs locally first
###############################################
...
echo -e "${YELLOW}Step 0: Building Java applications locally...${NC}"
...
echo -e "  View logs:        ${BLUE}./view-docker-logs.sh gateway${NC}"
...
echo -e "  Restart service:  ${BLUE}docker restart punchout-gateway${NC}"
echo ""
